...
public class MapEditor : MonoBehaviour
{
    ...
    /// ステージに置くオブジェクト
    /// </summary>
    [SerializeField] GameObject[] bc = new GameObject[20];
    ...
    Texture2D[] Sliced_texture = new Texture2D[21];
    string[] texture_name = new string[21]
    {
        "空白","","","","","","","","","","","","","","","","","","","",""
    };
    ...
    void OnGUI()
    {
        ...
        for (int i = 0; i < max_button; ++i)
        {
            ...
            if (GUI.Button(new Rect(px + (40 * i), 60, 40, 40), texture_name[i]))
            {
                Set_UIpos(i);
                now_block = i;
            }
